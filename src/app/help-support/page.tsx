      ...
      <div className={styles.helpAndSupport}>
        ...
        <div className={styles.frameParent2}>
          <div className={styles.frameParent3}>
            ...
            <BookDemoTrigger>
              <div
                className={`${styles.frameChild2} ${styles.bookDemoVisual}`}
              >
                Book a Demo
              </div>
            </BookDemoTrigger>
        ...
        <div className={styles.comprehensiveSupportParent}>
          ...
          <div className={styles.frameParent7}>
            <div
              className={`${styles.supportCard} ${styles.supportCardPurple}`}
            >
            ...
            <div
              className={`${styles.supportCard} ${styles.supportCardPink}`}
            >
              <div className={styles.supportCardInner}>
                <div className={styles.supportCardContent}>
                  <b className={styles.supportCardTitle}>
            ...
            <div
              className={`${styles.supportCard} ${styles.supportCardGreen}`}
            >
              <div className={styles.supportCardInner}>
                <div className={styles.supportCardContent}>
                  <b className={styles.supportCardTitle}>
            ...
            <div
              className={`${styles.supportCard} ${styles.supportCardBlue}`}
            >
              <div className={styles.supportCardInner}>
                <div className={styles.supportCardContent}>
                  <b className={styles.supportCardTitle}>
            ...
            <div className={styles.frameWrapper2}>
              <div className={styles.frameParent10}>
                <div className={styles.frameParent11}>
                  <div
                    className={`${styles.resourceIcon} ${styles.resourceIconPink}`}
                  >
                    <div className={styles.resourceIconInner}>
                      <Image
                        src="/icons/compasswhite.svg"
                        width={34}
                        height={34}
                        alt=""
                      />
                ...
                <div className={styles.frameParent11}>
                  <div
                    className={`${styles.resourceIcon} ${styles.resourceIconPurple}`}
                  >
                    <div className={styles.resourceIconInner}>
                      <Image
                        src="/icons/book-plus.svg"
                        width={34}
                        height={34}
                        alt=""
                      />
                ...
                <div className={styles.frameParent11}>
                  <div
                    className={`${styles.resourceIcon} ${styles.resourceIconBlue}`}
                  >
                    <div className={styles.resourceIconInner}>
                      <Image
                  ...
                  <b className={styles.assessmentReporting}>
                    Assessment &amp; Reporting Guides
                  </b>
                </div>

                <div className={styles.frameParent11}>
                  <div
                    className={`${styles.resourceIcon} ${styles.resourceIconTeal}`}
                  >
                    <div className={styles.resourceIconInner}>
                      <Image
                ...
                <div className={styles.frameParent11}>
                  <div
                    className={`${styles.resourceIcon} ${styles.resourceIconGold}`}
                  >
                    <div className={styles.resourceIconInner}>
                      <Image
                        src="/icons/settingswhite.svg"
                        width={34}
                        height={34}
                        alt=""
                      />
          ...
          <div className={styles.frameParent16}>
            ...
            <div className={styles.supportForYourLearningEcosParent}>
              <b className={styles.supportForYour}>
                Support for Your Learning Ecosystem
              </b>
